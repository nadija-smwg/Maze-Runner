...
static PID _heading_pid(HEADING_KP, HEADING_KI, HEADING_KD, -MAX_OMEGA_RAD_S, MAX_OMEGA_RAD_S);
...
float heading_controller_update(float target_heading_deg,
    ...
    float omega = _heading_pid.compute(continuous_setpoint, continuous_measurement, dt);
